    ...
    <div className="bg-black/10 backdrop-blur-xl rounded-2xl border border-gray-700/20 p-4 sm:p-6 h-full">
      ...
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        ...
        <Button
          ...
          className={`text-xs px-3 py-2 sm:py-1 transition-all duration-500 ${
            isActive 
      ...
      <div className="relative mb-3 sm:mb-4 flex-1">
        <Textarea
          ...
          } resize-none rounded-xl transition-all duration-500 focus:border-cyan-400/50 focus:bg-black/30 text-sm ${
      ...
      <div className="flex items-center justify-between text-xs">
        <div className="flex space-x-3 sm:space-x-4">
          ...
          {/* Enhanced Voice Waveform Display */}
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="flex space-x-1">
              {['◐', '◑', '◒', '◓'].map((glyph, i) => (
                <span
                  key={i}
                  className="text-xs text-blue-400/60 transition-all duration-300 hover:text-blue-300/80"
                  style={{
