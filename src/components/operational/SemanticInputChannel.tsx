    ...
    <div className="bg-black/10 backdrop-blur-xl rounded-2xl border border-gray-700/20 p-6 h-full">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button
          ...
          } border rounded-lg hover:scale-105`}
        >
      ...
      <div className="relative mb-4 flex-1">
        <Textarea
          ...
          className="bg-black/20 border-gray-700/30 text-gray-200/90 placeholder:text-gray-500/50 min-h-[100px] resize-none rounded-xl transition-all duration-300 focus:border-cyan-400/40 focus:bg-black/30"
          disabled={!isActive}
        />
